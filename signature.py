...
def generate_signature_for_GET_API() :
    ...
    canonical_uri = '/v2/checkoutSessions/xxxxxxx-xxxx-xxxx-xxxx-xxxxxxx' # Change URI based on your API
...
def generate_signature_for_API() :
    ...
    public_key = 'PUBLIC_KEY' # Enter you public key ID
    private_key = RSA.importKey(open('private.pem').read()) # Enter you private key file path
    payload_json = '{"webCheckoutDetails":{"checkoutReviewReturnUrl":"https://www.amazon.com/return_url"},"storeId":"amzn1.application-oa2-client.xxxxxxxxxx"}' # Enter your API request payload
    # Generating a canonical request
    canonical_querystring = ''
    amz_pay_date = get_date_time()
